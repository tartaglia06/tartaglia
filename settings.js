...
//𝙰𝙳𝙾𝙿𝚃𝙴𝙳 𝙵𝚁𝙾𝙼  𝚂𝙲𝚁𝙸𝙿𝚃 𝙾𝙵 𝙲𝙷𝙴𝙴𝙼𝚂𝙱𝙾𝚃 𝚅2 𝙱𝚈 ℳ𝒜ℒ𝒜𝒦 
//
//════════════════════════════//
...
global.mess = {
    ...
    admin: '*「 هـذا الامـر فـقـط لـ الرجاله المشرفين,استرجل وجرب مره اخرى 」◣*',
    botAdmin: '*「 اعـطـنـي إشـراف لـتـفـعـيـل  الامـر 」◣*',
    owner: '*「 هـذا الامـر فـقـط لـ الـمـالـك هىهىهى 」◣*',
